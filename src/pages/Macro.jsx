  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
        ...
        <div>
          <h2 style={{ fontFamily: Fs, fontSize: 20, fontWeight: 400, color: T.text, margin: 0 }}>{r.label}</h2>
...
function CompareView({ T, allData }) {
  ...
  return (
    <div>
      <h2 style={{ fontFamily: Fs, fontSize: 19, fontWeight: 400, color: T.text, margin: "0 0 3px" }}>
  ...
  return (
    <div style={{ padding: standalone ? 22 : 0, background: standalone ? T.bg : "transparent", minHeight: standalone ? "100vh" : "auto", fontFamily: Fn, transition: "background 0.3s" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        <div>
          <h1 style={{ fontFamily: Fs, fontSize: 23, fontWeight: 300, color: T.text, margin: 0, letterSpacing: "-0.02em" }}>
            {"Macro "}
