...
export const businessDescription = [
  ...
  "End-market exposure is heavily weighted toward pharma and biotech, with the balance spread across academic and government laboratories, industrial and applied markets, and clinical diagnostics customers. The company has no material customer concentration — its largest single customer represents less than 10 percent of revenue, which is itself a quality marker for a $44 billion business serving roughly 400,000 customer accounts globally.",
];
