...
export const IconDanaher = () => <svg {...s} viewBox="0 0 16 16"><circle cx="8" cy="8" r="6"/><path d="M8 2v12M2 8h12" strokeWidth="1"/><circle cx="8" cy="8" r="2.2" fill="currentColor" stroke="none"/></svg>;

export const iconMap = { overview: IconOverview, holdings: IconHoldings, allocation: IconAllocation, markets: IconMarkets, research: IconResearch, thematic: IconThematic, macro: IconMacro, risk: IconRisk, scenarios: IconScenarios, watchlist: IconWatchlist, claude: IconClaude, settings: IconSettings, danaher: IconDanaher };
